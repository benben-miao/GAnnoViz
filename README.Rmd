...
```{r plot_gene_domains, fig.width=10, fig.height=7}
# Plot TP53 domian
...
```{r plot_deg_volcano, fig.width=10, fig.height=7}
# Volcano plot
plot_deg_volcano(
  deg_file = deg_file,
  id_col = "GeneID",
...
```{r plot_deg_chrom, fig.width=10, fig.height=7}
# Plot chrom DEGs
plot_deg_chrom(
  deg_file = deg_file,
  gff_file = gff_file,
...
```{r plot_deg_exp, fig.width=10, fig.height=7}
plot_deg_exp(
  deg_file = deg_file,
  gff_file = gff_file,
  format = "auto",
...
```{r plot_dmg_exp, fig.width=10, fig.height=7}
# Plot DMG expression
plot_dmg_exp(
  dmr_file = dmr_file,
  orientation = "horizontal",
